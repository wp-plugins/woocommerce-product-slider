...
This is CarouFredSel library based woocommerce product slider / carousel.
...
* Ability to Schedule sliders to show on specific periodes using start and end date.
...
* Option to enable CSS3 / hardware accelaration for transitions.  
...
* Simple embedding using shortcode, PHP function, shortcode generator on post editor or via widget.
